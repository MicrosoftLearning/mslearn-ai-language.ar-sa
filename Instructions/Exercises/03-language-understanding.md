...
1. عند المطالبة، أدخل التعبيرات لاختبار التطبيق. على سبيل المثال، جرِّب:
    ...
    *أي يوم الموافق 01/01/2025؟*
    ...
    > **ملاحظة**: **ملاحظة**: المنطق في التطبيق بسيط عمدًا، ولديه عدد من القيود. على سبيل المثال، عند الحصول على الوقت، يتم دعم مجموعة مقيدة فقط من المدن ويتم تجاهل التوقيت الصيفي. الهدف هو رؤية مثال على نمط نموذجي لاستخدام خدمة اللغة حيث يجب أن يكون التطبيق الخاص بك:
