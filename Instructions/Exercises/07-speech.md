...
> **ملاحظة** يتطلب هذا التمرين استخدام كمبيوتر مزود بسماعات/سماعات رأس. للحصول على أفضل تجربة، يلزم وجود ميكروفون أيضاً. قد تتمكن بعض البيئات الظاهرية المستضافة من التقاط الصوت من الميكروفون المحلي، ولكن إذا لم ينجح ذلك (أو لم يكن لديك ميكروفون على الإطلاق)، فيمكنك استخدام ملف صوتي متوفر لإدخال الكلام. اتبع الإرشادات بعناية، حيث ستحتاج إلى تحديد خيارات مختلفة استناداً إلى ما إذا كنت تستخدم ميكروفوناً أو ملفاً صوتياً.

## توفير مورد *الكلام بالذكاء الاصطناعي في Azure*

إذا لم يكن لديك بالفعل مورداً في اشتراكك، فسيتعين عليك توفير مورد **الكلام بالذكاء الاصطناعي في Azure**.

1. افتح مدخل Azure على `https://portal.azure.com`، وسجل الدخول باستخدام حساب Microsoft المقترن باشتراك Azure.
1. في حقل البحث في الأعلى، ابحث عن **خدمات الذكاء الاصطناعي في Azure** واضغط على **Enter**، ثم حدد **إنشاء** ضمن **خدمة الكلام** في النتائج.
...
التطبيقات لكل من C# وPython متوفرة. يتميز كلا التطبيقين بالوظيفة نفسها. أولاً، ستكمل بعض الأجزاء الرئيسية من التطبيق لتمكينه من استخدام مورد الكلام بالذكاء الاصطناعي في Azure الخاص بك.
...
1. يمكن تحديث قيم التكوين لتضمين **المنطقة** **ومفتاح** من مورد الكلام بالذكاء الاصطناعي الذي أنشأته (المتوفر في صفحة **المفاتيح ونقطة النهاية** لمورد الكلام بالذكاء الاصطناعي في Azure  لديك في مدخل Azure).
